  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: RepaintBoundary(
        child: Tooltip(
          tooltip: (_) => TooltipContainer(child: Text(widget.title)),
          child: MouseRegion(
      ...
      child: DBlurContainer(
        child: Row(
          children: [
            ...
            DTopbarButton.icon(icon: Icons.menu_open, menuControllerRef: widget.menuController, menu: OverviewMenu()),
            const Spacer(),
