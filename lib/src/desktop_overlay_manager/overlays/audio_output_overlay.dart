...
class AudioOutputOverlay extends StatefulWidget {
  const AudioOutputOverlay({super.key});

  @override
  State<AudioOutputOverlay> createState() => _AudioOutputOverlayState();
}

class _AudioOutputOverlayState extends State<AudioOutputOverlay>
    with OsdOverlayMixin<AudioOutputOverlay> {
